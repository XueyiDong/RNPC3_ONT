...
pdf("plots/longDTE/topN_MI_DTE.pdf", height = 5, width = 8)
...
plot_grid(bcv.plot + 
            ...
            geom_hline(yintercept = layer_scales(bcv.plot.short)$y$range$range, colour = "grey30"),
          bcv.plot.short + 
            theme(legend.position = "none"),
          leg,
...
barcodeplot(res$table$logFC, index = x$genes$isMinorIntron,
            ...
            main = paste0("ONT minor intron genes, n=",
                          res.fry$NGenes,
                          "\nFry mixed p-value=",
                          signif(res.fry$PValue.Mixed, 3)))
pdf("plots/longDTE/barcode_minorIntron.pdf", height = 5, width = 20)
barcodeplot(res$table$logFC, index = x$genes$isMinorIntron,
            xlab = "log fold change",
            main = paste0("ONT minor intron genes, n=",
                          res.fry$NGenes,
            ...
            cex = 2)
dev.off()
pdf("plots/longDTE/barcode_minorIntron_small.pdf", height = 5, width = 8)
barcodeplot(res$table$logFC, index = x$genes$isMinorIntron,
            xlab = "log fold change",
            main = paste0("ONT minor intron genes, n=",
                          res.fry$NGenes,
...
#             xlab = "log fold change",
#             main = paste0("ONT Minor IR top 40 genes, n=",
#                           res.fry$NGenes,
#                           "\nFry mixed p-value=",
#                           signif(res.fry$PValue.Mixed, 3)))
pdf("plots/longDTE/barcode_MinorIR.pdf", height = 5, width = 8)
barcodeplot(res$table$logFC, index = x$genes$isMinorIR,
            xlab = "log fold change",
            main = paste0("ONT Minor IR top 40 genes, n=",
                          res.fry$NGenes,
...
#             xlab = "log fold change",
#             main = paste0("ONT Minor AS top 40 gene, n=",
#                           res.fry$NGenes,
#                           "\nFry mixed p-value=",
#                           signif(res.fry$PValue.Mixed, 3)))
pdf("plots/longDTE/barcode_minorAS.pdf", height = 5, width = 8)
barcodeplot(res$table$logFC, index = x$genes$isMinorAS,
            xlab = "log fold change",
            main = paste0("ONT Minor AS significant genes,n=",
                          res.fry$NGenes,
                          "\nFry mixed p-value=",
                          signif(res.fry$PValue.Mixed, 3)),
            cex.lab = 1.5,
...
#             xlab = "log fold change",
#             main = paste0("ONT IR finder unbiased top 40 genes, n=",
#                           res.fry$NGenes,
#                           "\nFry mixed p-value=",
#                           signif(res.fry$PValue.Mixed, 3)))
pdf("plots/longDTE/barcode_IRFinder.pdf", height = 5, width = 8)
barcodeplot(res$table$logFC, index = x$genes$isIrFinder,
            xlab = "log fold change",
            main = paste0("ONT IR finder unbiased top 40 genes, n=",
                          res.fry$NGenes,
...
topN.ts <- top_n_mi(ts)
pdf("plots/longDTU/topN_MI_DTU.pdf", height = 5, width = 4)
...
pdf("plots/longDTU/barcode_minorIntron.pdf", height = 5, width = 16)
barcodeplot(ds$t[, 2], index = ds$genes$isMinorIntron,
            main = paste0("ONT transcripts of minor intron genes, n=",
            ...
            cex.main = 1.5)
dev.off()
pdf("plots/longDTU/barcode_minorIntron_small.pdf", height = 5, width = 8)
barcodeplot(ds$t[, 2], index = ds$genes$isMinorIntron,
            main = paste0("ONT transcripts of minor intron genes, n=",
                          sum(ds$genes$isMinorIntron),
                          "\nFisher's exact test p-value=",
...
pdf("plots/longDTU/barcode_minorIR.pdf", height = 5, width = 8)
barcodeplot(ds$t[, 2], index = ds$genes$isMinorIR,
            main = paste0("ONT transcripts of minor IR top 40 genes, n=",
...
test.down$p.value
pdf("plots/longDTU/barcode_minorAS.pdf", height = 5, width = 8)
barcodeplot(ds$t[, 2], index = ds$genes$isMinorAS,
             main = paste0("ONT transcripts of minor AS significant genes, n=",
...
test.down$p.value
pdf("plots/longDTU/barcode_IRFinder.pdf", height = 5, width = 8)
barcodeplot(ds$t[, 2], index = ds$genes$isIrFinder,
           main = paste0("ONT transcripts of IR Finder top 40 genes, n=",
