...
3. Visualization of coverage for Stephen's interesting genes, and add heatmap for transcripts expression

4. Short read coverage plots

5. Gene set test for DTU results. Perhaps Fisher's exact test?
