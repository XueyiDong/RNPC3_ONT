...
pdf("plots/shortDTE/barcode_minorIntron.pdf", height = 5, width = 8)
barcodeplot(res$table$logFC, index = x$genes$isMinorIntron,
            main = "Illumina minor intron genes, targeted vs control" ,
...
topN.ts <- top_n_mi(ts)
pdf("plots_short/topN_MI_DTU.pdf", height = 5, width = 8)
...
pdf("plots_short/topN_MI_DTU_tx.pdf", height = 5, width = 8)
