...
pdf("plots/shortDTE/barcode_minorIntron.pdf", height = 5, width = 16)
barcodeplot(res$table$logFC, index = x$genes$isMinorIntron,
            xlab = "log fold change",
            main = paste0("Illumina minor intron genes, n=",
                          res.fry$NGenes,
